...
describe('Autenticação', ()=> {
    ...
    describe('Logado', () => {
        it('Usuario utilizou o token correto! Code [200]', async () => {
            const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5NDBhOTBlLWViN2YtNGFmZS04MTE0LWQzMzFiNDY5NTA3MyIsImlhdCI6MTczNTMwODM0NCwiZXhwIjoxNzY2ODQ0MzQ0fQ.XpJQpbSShEoNlzRFbhUobKsuhlgGgmXlwHyE_KCJZyw'

            const {body, statusCode} = await request.get('/auth/protected') .set('Authorization', 'Bearer '+token);
            expect(statusCode).toBe(200)
            expect(body.success).toBeTruthy()
        })

        it('Usuario utilizou o token expirado! Code [401]', async () => {
            const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5NDBhOTBlLWViN2YtNGFmZS04MTE0LWQzMzFiNDY5NTA3MyIsImlhdCI6MTczNTMwNTMxNiwiZXhwIjoxNzM1MzA1MzE3fQ.xNLIgAXhMZXenf97nGvIWeCOGvpp1kTwrF9XQXceHpA'
        ...
        it('Usuario utilizou o token incorreto! Code [500]', async () => {
            const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjU5NDBhOTBlLWViN2YtNGFmZS04MTE0LWQzMzFiNDY5NTA3MyIsImlhdCI6MTczNTMwNjk3MiwiZXhwIjoxNzM1MzkzMzcyfQ.x8mqn1qJ_GS24CY_zBfAlCYKL9hDBT5Fvel0YYaaxSY'
